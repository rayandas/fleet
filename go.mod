...
replace (
	github.com/rancher/gitjob => github.com/rayandas/gitjob v1.27.2-rancher1
...
replace (
	...
	k8s.io/apimachinery => k8s.io/apimachinery v0.27.2 // indirect
	k8s.io/apiserver => k8s.io/apiserver v0.27.2
	k8s.io/cli-runtime => k8s.io/cli-runtime v0.27.2
	k8s.io/client-go => github.com/rayandas/client-go v0.0.0-20230518103033-4c3075f56577
...
require (
	...
	github.com/rancher/gitjob v0.1.58
